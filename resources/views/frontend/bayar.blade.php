...
<body>
    ...
    <div id="snap-container" class="md:w-2/5 w-full bg-white mx-auto border rounded-sm items-center mt-11 p-5">
        ...
        <form action="{{route('pesan')}}" method="post">
            ...
            <input type="hidden" name="idproduk" value="{{$produk->nama}}">
