                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{route('category.show', $category->id)}}" class="font-medium text-white bg-green-500 p-2 rounded-lg hover:bg-green-800">Show</a>
                                <a href="{{route('category.edit', $category->id)}}" class="font-medium text-white bg-blue-500 p-2 rounded-lg  hover:bg-blue-800">Edit</a>
                            </td>
                        </tr>
                        @empty
