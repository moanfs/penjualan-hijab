<x-admin-layout>
    @section('title') {{'Edit Merek'}} @endsection
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Form Edit Brand</span>
                        </div>
                    </li>
                </ol>
            ...
            <div class="bg-white rounded p-4">
                <form action="{{ route('brand.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex gap-5">
                        <label for="logolama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Logo</label>
                        <img class="h-auto max-w-[8rem] shadow-md my-3" src="{{ asset('/storage/brands/'.$brand->logo) }}" alt="logo">
                    </div>
                    <div>
                        <label for="logo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload Logo </label>
