        ...
        <div class="p-4 dark:border-gray-700 mt-14">
            ...
            <div class="bg-white rounded p-4">
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        <label for="weight" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Berat Produk (gram)<span class="text-rose-500">*</span></label>
                        <input type="text" name="weight" id="weight" value="{{old('weight')}}" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="500">
                        @error('weight')
                        <span class="text-rose-500">
                            <p>{{ $message }}</p>
                        </span>
