    ...
    <div class="container w-[80%] p-6 mx-auto">
        <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    <a href="#">
                        <p>Mutiara Hijab Shop</p>
                    </a>

                    <p class="max-w-sm mt-2 text-gray-500 dark:text-gray-400">Toko Hijab yang menjual berbagai macam hijab yang akan memenuhi kebutuhan anda</p>
            ...
            <div class="mt-6 lg:mt-0 lg:flex-1">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <a href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Trending</a>
                        <a href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">style</a>
                    ...
                    <div>
                        ...
                        <a href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Hijab</a>
                    ...
                    <div>
                        ...
                        <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">hijab@email.com</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <p class="text-center text-gray-500 dark:text-gray-400">© Mutiara 2023</p>
        </div>
    </div>
</footer>